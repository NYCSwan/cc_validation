...
export type Mutation = {
  __typename?: 'Mutation';
  validateCreditCard: Scalars['Boolean']['output'];
};


export type MutationValidateCreditCardArgs = {
  creditCardNumber: Scalars['String']['input'];
};
...
export type MutationResolvers<ContextType = any, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = {
  validateCreditCard?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType, RequireFields<MutationValidateCreditCardArgs, 'creditCardNumber'>>;
};
